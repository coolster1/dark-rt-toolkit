...
groupRts("C:\\toolkit_sandbox\\redo_mon_run",
         so_far = 15000, rtn_type = 'split', display_filename = False,
         filename_to_write = "C:\\toolkit_sandbox\\redo_mon_run\\split_false.csv")
